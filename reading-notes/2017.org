...
1. package javafx.application does not exist
cp /usr/java/jdk1.8.0_121/jre/lib/ext/jfxrt.jar /usr/lib/jvm/java-1.8.0-oracle.x86_64/jre/lib/ext

2. .git directory is not found
